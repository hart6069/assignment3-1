...
/**
 Base class for all Assignment3 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Assignment3 view hierarchy (such as wrapped iOS UIViews) was touched.
