...
/**
 The base class for all Assignment3 modules
 */
...
/**
 Assignment3 Platform calls this method on startup.
 */
-(void)startup;

/**
 Assignment3 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Assignment3 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Assignment3 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Assignment3 Platform calls this method on resume.
 @param sender The sender of the event.
 */
