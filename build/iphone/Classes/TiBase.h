...
// in simulator we redefine to format for Assignment3 Developer console
...
{\
	NSString * exceptionName = [@"org.assignment3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.assignment3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIAssignment3NativeItemNone = -1, 
	UIAssignment3NativeItemSpinner = -2,
	UIAssignment3NativeItemProgressBar = -3,
	
	UIAssignment3NativeItemSlider = -4,
	UIAssignment3NativeItemSwitch = -5,
	UIAssignment3NativeItemMultiButton = -6,
	UIAssignment3NativeItemSegmented = -7,
	
	UIAssignment3NativeItemTextView = -8,
	UIAssignment3NativeItemTextField = -9,
	UIAssignment3NativeItemSearchBar = -10,
	
	UIAssignment3NativeItemPicker = -11,
	UIAssignment3NativeItemDatePicker = -12,
	
	UIAssignment3NativeItemInfoLight = -13,
	UIAssignment3NativeItemInfoDark = -14,
	
	UIAssignment3NativeItemDisclosure = -15,
	
	UIAssignment3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Assignment3 instances of
