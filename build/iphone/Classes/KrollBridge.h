...
@interface Assignment3Object : KrollCoverageObject {
#else
@interface Assignment3Object : KrollObject {
#endif
@private
...
extern NSString * Assignment3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Assignment3Object *_assignment3;
    KrollObject* console;
	BOOL shutdown;
