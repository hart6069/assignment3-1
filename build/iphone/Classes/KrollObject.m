...
//@interface Assignment3Object : NSObject
//@end

@interface Assignment3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Assignment3Object class]])
		{
			for (NSString *key in [[(Assignment3Object*)o modules] allKeys])
			{
